...
- `index.html` — the portfolio site. Open this file in a browser to view locally.
...
3. GitHub Pages will publish the site at `https://<your-username>.github.io/PORTFOLIO-PRJCT-MIL/` after a minute.
